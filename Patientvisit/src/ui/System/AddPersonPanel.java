          ...
          if (dob.getText().equals("") || (!(Pattern.matches("^(1[0-2]|0[1-9])-(3[01]|[12][0-9]|0[1-9])-[0-9]{4}$", dob.getText())))) {
           ...
           /* if(ssn.getText().equals("") || (!(Pattern.matches("^(?!000|666)[0-8][0-9]{2}-(?!00)[0-9]{2}-(?!0000)[0-9]{4}$",ssn.getText())))){
            ...
            if(ssn.getText().length()<10){
              flag = 1;
              JOptionPane.showMessageDialog(null,"Please enter a valid SSN number", "Error", JOptionPane.ERROR_MESSAGE);
            } 
            
            if(zip.getText().length()>6){
              flag = 1;
              JOptionPane.showMessageDialog(null,"Zip code should not exceed 6 characters", "Error", JOptionPane.ERROR_MESSAGE);
            }
